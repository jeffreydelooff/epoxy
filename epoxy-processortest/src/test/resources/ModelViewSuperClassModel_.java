...
public class ModelViewSuperClassModel_ extends EpoxyModel<ModelViewSuperClass> implements GeneratedModel<ModelViewSuperClass>, ModelViewSuperClassModelBuilder {
  ...
  public ModelViewSuperClassModel_ onBind(OnModelBoundListener<ModelViewSuperClassModel_, ModelViewSuperClass> listener) {
    onMutation();
   ...
   * <p>
   * You may clear the listener by setting a null value, or by calling {@link #reset()} */
  public ModelViewSuperClassModel_ onUnbind(OnModelUnboundListener<ModelViewSuperClassModel_, ModelViewSuperClass> listener) {
    onMutation();
  ...
  @Override
  public ModelViewSuperClassModel_ spanSizeOverride(@Nullable EpoxyModel.SpanSizeOverrideCallback arg0) {
